...
public class MyAdapterQuiz extends RecyclerView.Adapter<MyAdapterQuiz.ViewHolder> {

    private List<RecyclerItem> listaItens;
    private Context mContext;

    public MyAdapterQuiz(List<RecyclerItem> listaItens, Context mContext) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.feed_item_quiz, viewGroup, false);
